...
functionList effectListNoAudio[] = {threeSine,   //crazy colour ripples
                                    dotSpinner,
                                    ringFlasher,
                                    sparkle,
                                    drawVU,
                                    //threeDee,
                                    scrollTextZero, // appears to be random traces
                                    plasma, //lovely palletted plasma ring
                                    //RGBpulse,
                                    confetti, //palletted random sparkles
                                    rider, //double kitt rider
                                    scrollTextOne, // appears to be random traces
                                    glitter, //superfast glitter in palletted colour
                                    //drawAnalyzer,
                                    slantBars, //nicely fading paletted dashes
                                    scrollTextTwo, // appears to be random traces
                                    colorFill, //wipes of colours
                                    sideRain //nice lively traces in palletted colours
                                   };
...
void loop()
{
  ...
  switch (audioEnabled) {
    ...
    case false:
      ...
      if (effectListNoAudio[currentEffect] == sparkle) fadeAll(1);
      break;
  }
